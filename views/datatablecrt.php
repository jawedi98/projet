									...
									<div class="card-body">
										<div class="table-responsive">
											<div id="example-2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="example-2_length"><div class="row"><div class="col-sm-12"><table id="example-2" class="table table-striped table-bordered border-t0 text-nowrap w-100 dataTable no-footer" role="grid" aria-describedby="example-2_info">
												<thead>
													<tr role="row"><th class="text-center sorting_asc" tabindex="0" aria-controls="example-2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="nom: activate to sort column descending" style="width: 88.2px;">id</th><th class="text-center sorting" tabindex="0" aria-controls="example-2" rowspan="1" colspan="1" aria-label="prenom: activate to sort column ascending" style="width: 93px;">code</th><th class="text-center sorting" tabindex="0" aria-controls="example-2" rowspan="1" colspan="1" aria-label="identifiant: activate to sort column ascending" style="width: 242.6px;">delai</th></tr>
												</thead>
												<tbody>
													<?PHP
