										...
										<div id="table" class="table-responsive table-editable">
											<table class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap">
												...
												<tr>
													...
													<td class="pt-3-half" ><?PHP echo $row['adresse']; ?></td>
													<td class="pt-3-half" ><?PHP echo $row['telephone']; ?></td>
													<td class="pt-3-half"><?PHP echo $row['password']; ?></td>
													<td class="pt-3-half">
													...
													<td>
														<form method="POST" action="supprimerClient.php"><span class=""><input type="submit" class="btn btn-danger btn-rounded btn-sm my-0" value="Supprimer"></span>
