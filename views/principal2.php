...
$listeClients2=$client1C->afficherClients2();
										...
										<div id="table" class="table-responsive table-editable">
											<table class="table table-bordered table-responsive-md table-striped text-center mb-0 text-nowrap">
												...
												<tr>
													...
													<td class="pt-3-half" contenteditable="true"><?PHP echo $row['telephone']; ?></td>
													...
													<td class="pt-3-half"> <form method="POST" action="afficherClients1.php">
														<span class="table-up"><a href="principal1.php" class="indigo-text"><i class="fa fa-long-arrow-up" aria-hidden="true"></i></a></span>
													</form>
													<form method="POST" action="afficherClients2.php">
														<span class="table-down"><a href="principal2.php" class="indigo-text"><i class="fa fa-long-arrow-down" aria-hidden="true"></i></a></span>
													</td>
